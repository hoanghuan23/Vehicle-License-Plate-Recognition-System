...
root = tk.Tk()
root.title("Chọn file xử lý")
root.geometry("1000x600")

# chen anh
bg = tk.PhotoImage(file="google.png")
...
def process_image(image_path):
    ...
    for r in results:
        ...
        labeled_image.show()
    messagebox.showinfo("Processing", f"Đang xử lý ảnh: {image_path}")
...
def process_video(video_path):
    ...
    model_path = 'F:/Python/biensoxe/runs/detect/train3/weights/best.pt'
    ...
    messagebox.showinfo("Processing", f"Xử lý xong video được lưu tại: {video_path}")
